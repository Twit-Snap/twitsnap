...
const user = {
  ...
  tweets: [
    ...
    {
      id: '2',
      content: 'Happy to score and contribute to the win. Fuerza Argentina! 🇦🇷',
      date: '2023-04-28'
    },
    {
      id: '3',
      content: 'Great training session today. Always working to improve. 💪',
      date: '2023-04-25'
    },
    {
      id: '4',
      content: "Thank you to all the fans for your constant support. You're amazing! ❤️",
      date: '2023-04-22'
    },
